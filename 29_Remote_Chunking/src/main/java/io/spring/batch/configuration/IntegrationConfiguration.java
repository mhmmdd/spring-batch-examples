...
public class IntegrationConfiguration {
    ...
    public ChunkProcessorChunkHandler<Customer> chunkProcessorChunkHandler(ItemProcessor<Customer, Customer> itemProcessor, ItemWriter<Customer> itemWriter) throws Exception {
